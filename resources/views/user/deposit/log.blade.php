        ...
        <table class="data-table dt-init user-tnx">
          <thead>
            <tr class="data-item data-head">
              ...
              <th class="data-col dt-amount">Gateway</th>
          ...
          <tbody>
            ...
            <tr class="data-item">
              ...
              <td class="data-col dt-type">
                ...
                @elseif($data->status == "Pending")
                <span class="dt-type-md badge badge-outline badge-warning badge-md">Not Paid</span><span class="dt-type-sm badge badge-sq badge-outline badge-warning badge-md">P</span>
                &nbsp;&nbsp
                    ...
                    <div class="content-area">
                      ...
                      <div class="data-details d-md-flex">
                        ...
                        <div class="fake-class"><span class="data-details-title">Transaction Status</span>
                          ...
                          @elseif($data->status == "Paid")
                          <span class="badge badge-warning ucap">Paid</span>
                          @elseif($data->status == "Declined")
                        ...
                        <div class="fake-class"><span class="data-details-title">Payment Gateway</span><span class="data-details-info">{{isset($data->payment_method_id) ? $data->payment_method_id : 'N/A'}}</span></div>
                        <div class="fake-class"><span class="data-details-title">Payment Method</span><span class="data-details-info">{{isset($data->method->name) ? $data->method->name : 'N/A'}}</span></div>
                      </div>
                      ...
                      <ul class="data-details-list">
                        ...
                        <li><div class="data-details-head">Tx Hash</div><div class="data-details-des"><span>{{$data->trx}}</span> <span></span></div></li><!-- li -->
                        <li>
                      ...
                      <div class="text-left mt-3">
                        ...
                        <a href="{{ route('confirm_deposit', $data->trx) }}" class="btn btn-auto btn-primary btn"><span>Pay <span class="d-none d-xl-inline-block">Now</span></span><em class="ti ti-wallet"></em></a>
                      </div>
                      @endif
                      @endif
                    </div><!-- .modal-content -->
