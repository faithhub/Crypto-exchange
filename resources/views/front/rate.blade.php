...
<!-- .header-main @e --><!-- Banner @s --><div class="header-banner bg-theme-grad-s2"><div class="nk-banner"><div class="banner banner-page"><div class="banner-wrap"><div class="container"><div class="row justify-content-center"><div class="col-xl-6 col-lg-9"><div class="banner-caption cpn tc-light text-center"><div class="cpn-head"><h2 class="title ttu">Exchange Rate</h2><p>We ensure transparency on {{$basic->sitename}}. You have autonomy over your wallet and we make sure no fund is lost on trades.</p></div></div></div></div></div></div></div></div><!-- .nk-banner --><div class="nk-ovm shape-a-sm"></div></div><!-- .header-banner @e --></header><main class="nk-pages"><section class="section bg-white"><div class="container"><div class="row justify-content-around"><div class="col-lg-5 mgb-r"><h3 class="title title title-md">Supported Cryptocurrencies</h3><p>Our list of supported cryptocurrencies</p><table class="table"><tbody>
...
<div class="field-item"><label class="field-label">Input Amount</label><small><p>Enter amount in <code> USD </code> </p></small><div class="field-wrap"><input  id="mySelect2" onkeyup="myFunction()"  type="number" class="input-bordered" required></div></div>
